<?php
/**
 * SkillBridge - Faculty Institutional Announcements Page
 * Allows Faculty to create announcements & edit/delete ONLY their own announcements.
 */
...
// Handle Form Submissions (Create, Edit, Delete) with strict ownership validation
...
<div class="d-flex flex-column flex-md-row justify-content-between align-items-md-center gap-3 mb-4">
    <div>
        <h3 class="fw-bold mb-1"><i class="bi bi-megaphone text-danger me-2"></i>Institutional & Class Announcements</h3>
        <p class="text-muted small mb-0">Publish announcements and view broadcasts from administration and peers</p>
    </div>
</div>
    ...
    <div class="col-12 col-lg-5">
        <div class="card border-0 shadow-sm rounded-4 h-100">
            <div class="card-header bg-white border-0 pt-4 px-4 pb-0">
                <h5 class="fw-bold text-dark mb-0"><i class="bi bi-send-fill text-danger me-2"></i>Create Announcement</h5>
            </div>
            <div class="card-body p-4">
                <form action="<?= BASE_URL ?>faculty/announcements.php" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="title" class="form-control" placeholder="e.g., Assignment #2 Deadline Extension" required>
                    </div>
