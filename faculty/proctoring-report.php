<?php
/**
 * SkillBridge - Faculty Proctoring Report Inspector
 * Displays detailed AI integrity checks and suspicious activity audit timelines.
 */
...
if (!$attempt) {
    ...
    redirect(BASE_URL . 'faculty/evaluate.php');
}
...
// Format time taken
$timeSeconds = (int)$attempt['time_taken_seconds'];
$mins = floor($timeSeconds / 60);
$secs = $timeSeconds % 60;
...
<div class="d-flex justify-content-between align-items-center mb-4 no-print">
    <a href="<?= BASE_URL ?>faculty/evaluate.php?student_id=<?= $attempt['student_id'] ?>" class="btn btn-sm btn-outline-secondary rounded-pill px-3">
        <i class="fa-solid fa-arrow-left me-1"></i> Back to Evaluation
    </a>
