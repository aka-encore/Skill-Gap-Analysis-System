<?php
/**
 * SkillBridge - Admin Student Import Portal
    ...
    if (!verify_csrf_token()) {
        ...
        if (empty($importRows) || !is_array($importRows)) {
            ...
            try {
                ...
                set_flash_message('success', "Successfully imported {$count} student records!");
...
$pageTitle = "Student CSV Import - Admin Portal";
include __DIR__ . '/../includes/header.php';
?>

<div class="d-flex flex-column flex-md-row justify-content-between align-items-md-center gap-3 mb-4">
    <div>
        <h3 class="fw-bold mb-1 text-dark"><i class="bi bi-cloud-arrow-up text-primary me-2"></i>Student Accounts CSV Import</h3>
        <p class="text-muted small mb-0">Import and configure student accounts directly using a standardized CSV template</p>
    </div>
    <a href="<?= BASE_URL ?>admin/students.php" class="btn btn-outline-secondary rounded-pill px-3 py-1.5 small fw-semibold">
...
<div class="row g-4">
    <div class="col-lg-8">
        <div class="saas-card p-5 text-center border-dashed position-relative" id="dropZone" style="border: 2px dashed var(--primary-light); background: rgba(79, 70, 229, 0.02); border-radius: 1rem;">
            <form action="<?= BASE_URL ?>admin/student-import.php" method="POST" enctype="multipart/form-data" id="uploadForm">
                <?= csrf_field() ?>
    ...
    <div class="col-lg-4">
        <div class="saas-card p-4">
            ...
            <a href="<?= BASE_URL ?>admin/student-import.php?action=download_template" class="btn btn-outline-primary w-100 rounded-pill fw-semibold py-2 small">
...
<div class="saas-card mb-4 p-4">
    <div class="border-bottom pb-3 mb-4 d-flex justify-content-between align-items-center">
        ...
        <div class="d-flex gap-2">
            <a href="<?= BASE_URL ?>admin/student-import.php" class="btn btn-light rounded-pill px-4 py-1.5 small fw-semibold">Cancel</a>
            <?php if ($previewData['valid_count'] > 0): ?>
                <form action="<?= BASE_URL ?>admin/student-import.php" method="POST" class="d-inline">
                    <?= csrf_field() ?>
